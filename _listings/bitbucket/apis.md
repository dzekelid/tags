...
- name: Bitbucket Parameters Repositories Username Repo Slug Refs Tags Name
  ...
  - type: x-postman-collection
    url: https://raw.githubusercontent.com/streamdata-gallery-topics/tags/master/_listings/bitbucket/repositories-username-repo-slug-refs-tags-name-parameters-postman.md
x-common:
- type: x-developer
