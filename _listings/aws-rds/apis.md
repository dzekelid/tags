...
- name: Amazon RDS API
  ...
  properties:
  - type: x-openapi-spec
    url: https://raw.githubusercontent.com/streamdata-gallery-topics/tags/master/_listings/aws-rds/action-removetagsfromresource-get.md
- name: Amazon RDS API List Tags For Resource
  ...
  properties:
  - type: x-openapi-spec
    url: https://raw.githubusercontent.com/streamdata-gallery-topics/tags/master/_listings/aws-rds/action-listtagsforresource-get.md
x-common:
- type: x-articles
